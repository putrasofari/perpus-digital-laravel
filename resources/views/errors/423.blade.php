...
<head>
    <meta charset="UTF-8">
    <title>423 — Akun Dinonaktifkan</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-slate-900 text-white flex items-center justify-center min-h-screen">
    <div class="text-center">
        <h1 class="text-8xl font-bold text-indigo-500">423</h1>
        <p class="text-2xl mt-4">Akun Anda Dinonaktifkan</p>
        <p class="text-slate-400 mt-2">Akun Anda dinonaktifkan oleh Admin. Hubungi Admin untuk mengaktifkannya kembali.
        </p>
